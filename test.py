...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        self.button4 = QPushButton('开始处理', self)
        self.button4.clicked.connect(self.startProcess) # 开始处理
        layout.addWidget(self.button4)

        self.button5 = QPushButton('生成位置', self)
        self.button5.clicked.connect(self.selectTargetPath)
    ...
    def selectTargetPath(self):
        file_path = QFileDialog.getOpenFileName(self, '选择生成位置')
        if file_path:
